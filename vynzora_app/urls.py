...
urlpatterns = [
    ...
    path('delete-technologies/<int:id>/',views.delete_technologies,name='delete_technologies'),
        ...
        # Blogs
    path('add-blog_details', views.add_blog_details, name='add_blog_details'),
    path('view-blog_details',views.view_blog_details,name='view_blog_details'),
    path('update-blog_details/<int:id>/',views.update_blog_details,name='update_blog_details'),
    path('delete-blog_details/<int:id>/',views.delete_blog_details,name='delete_blog_details'),
